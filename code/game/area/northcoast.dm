// Rogve Coast - the northern part of the map - may not be actually coast
/area/rogue/outdoors/beach/forest
	...
	first_time_text = "THE ROGVE COAST"
...
/area/rogue/outdoors/beach/forest/north
	name = "The Rogve Coast - North"
	threat_region = THREAT_REGION_AZUREAN_COAST

/area/rogue/outdoors/beach/forest/south
	name = "The Rogve Coast - South"
	threat_region = THREAT_REGION_AZUREAN_COAST
