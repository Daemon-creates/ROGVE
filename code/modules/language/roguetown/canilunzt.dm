/datum/language/canilunzt
	name = "Canilunzt"
	desc = "A somewhat simple language consisting of heavily articulate barks, growls, yaps, and combined movements of the tail and ears. It's natively spoken by the Lupian and Vulpine. Its parlance has been loosely compared to the Grenzel language group."
	speech_verb = "rrrfts"
	ask_verb = "rurs"
	exclaim_verb = "snaps"
	key = "l"
