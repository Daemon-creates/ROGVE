...
/client/proc/show_round_stats(featured_stat)
	...
	data += "<font color='#FFD700'><span class='bold'>Lizardvolk & Drakian:</span></font> [GLOB.azure_round_stats[STATS_ALIVE_LIZARDS] + GLOB.azure_round_stats[STATS_ALIVE_DRACON]]<br>"
	data += "<font color='#d49d7c'><span class='bold'>Beastvolk:</span></font> [GLOB.azure_round_stats[STATS_ALIVE_HALFKIN] + GLOB.azure_round_stats[STATS_ALIVE_WILDKIN] + GLOB.azure_round_stats[STATS_ALIVE_LUPIANS] + GLOB.azure_round_stats[STATS_ALIVE_VULPS] + GLOB.azure_round_stats[STATS_ALIVE_TABAXI]]<br>"
	data += "<font color='#9ACD32'><span class='bold'>Sahuagin:</span></font> [GLOB.azure_round_stats[STATS_ALIVE_AXIAN]]<br>"
